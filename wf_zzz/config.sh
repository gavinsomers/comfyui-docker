...
# Disable upgrades: set to "true" to disable upgrades (also disables USE_PIPUPGRADE and AUTO_UPDATE_COMFYUI)
#export DISABLE_UPGRADES="true"

# Auto-update ComfyUI: set to "false" to disable automatic git pull for ComfyUI, Manager, and custom nodes
# default is true, value must set to "false" to disable
#export AUTO_UPDATE_COMFYUI="false"
